          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <Card className="aspect-square cursor-pointer">
              <CardContent className="flex h-full flex-col items-center justify-center space-y-2">
                <Building className="text-foreground size-8 stroke-1 xl:size-10" />
            ...
            <Card className="aspect-square cursor-pointer">
              <CardContent className="flex h-full flex-col items-center justify-center space-y-2">
                <CalendarIcon className="text-foreground size-8 stroke-1 xl:size-10" />
                <div className="text-center">
                  <CardTitle className="text-base font-medium">
            ...
            <Card className="aspect-square cursor-pointer">
              <CardContent className="flex h-full flex-col items-center justify-center space-y-2">
                <Folder className="text-foreground size-8 stroke-1 xl:size-10" />
                <div className="text-center">
                  <CardTitle className="text-base font-medium">
