...
export function PageSeoForm({ slug }: Props) {
  ...
  const handleSubmit = async (values: WebsitePageSeoValues) => {
    ...
    try {
      await apiClient.put(`/api/website/seo/${slug}`, values)
        ...
        >
          <FieldGroup className="grid gap-5 md:grid-cols-2">
            ...
            <Field data-invalid={!!form.errors.metaTitleEn}>
              <FieldLabel htmlFor={`${slug}-meta-title-en`}>
                {t("fields.metaTitleEn")}
              </FieldLabel>
              <FieldDescription>{t("requiredHint")}</FieldDescription>
              <FieldContent>
                <Input
                  id={`${slug}-meta-title-en`}
            ...
            <Field data-invalid={!!form.errors.keywordsAr}>
              <FieldLabel htmlFor={`${slug}-keywords-ar`}>
                {t("fields.keywordsAr")}
              </FieldLabel>
              <FieldDescription>{t("optionalHint")}</FieldDescription>
              <FieldContent>
            ...
            <Field data-invalid={!!form.errors.keywordsEn}>
              <FieldLabel htmlFor={`${slug}-keywords-en`}>
                {t("fields.keywordsEn")}
              </FieldLabel>
              <FieldDescription>{t("optionalHint")}</FieldDescription>
              <FieldContent>
          ...
          <Field orientation="horizontal" className="items-center gap-3">
            ...
            <div className="flex flex-col gap-1">
              <FieldLabel htmlFor={`${slug}-robots-index`}>
